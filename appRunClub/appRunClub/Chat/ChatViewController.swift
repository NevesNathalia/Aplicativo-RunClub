...
class ChatViewController: UIViewController {
    ...
    let contact: [User] = [User(image: UIImage(named: "profile") ?? UIImage(), name: "Contato", message: "Mensagem", location: "", description: ""),
                           User(image: UIImage(named: "profile") ?? UIImage(), name: "Contato", message: "Mensagem", location: "", description: ""),
                           User(image: UIImage(named: "profile") ?? UIImage(), name: "Contato", message: "Mensagem", location: "", description: ""),
...
extension ChatViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.setupCell(data: contact[indexPath.row])
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let community = UIStoryboard(name: String(describing: CommunityGroupViewController.self), bundle: nil).instantiateViewController(withIdentifier: String(describing: CommunityGroupViewController.self))
